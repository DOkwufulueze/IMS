...
<input name="" type="button" value="Print Inventory" onclick="javascript:window.print()" style="cursor:pointer; float:left;" /><input name="" type="button" value="Save Inventory" onclick="document.location.href='reportToday.php'" style="cursor:pointer; float:left;" />&nbsp;&nbsp;&nbsp;
<a href="general.php">Go to General Inventory</a>
</li>
</ul>
</div>
